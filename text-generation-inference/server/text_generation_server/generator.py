...
class TpuGenerator(Generator):
    ...
    def prefill(self, batch: Batch) -> Tuple[List[Generation], CachedBatch]:
        ...
        print(f"Prefill setup took {end - start} seconds.")
        start = time.time()
        ...
        print(f"Prefill generation took {end - start} seconds.")
    ...
    def decode(self, batches: List[CachedBatch]) -> Tuple[List[Generation], CachedBatch]:
        ...
        # Reconstruct input_ids and position_ids from slots
        input_ids = None
    ...
    def _generate_token(
        ...
        print(f"pre-Mark step took {end - start} seconds.")
        start = time.time()
        # print(f"input_ids.shape: {input_ids.shape}")
        # for k, v in forward_extra_params.items():
        #     if v is None:
        #         print(f"{k}: None")
        #     else:
        #         print(f"{k}: {v}")
        ...
        print(f"Model forward took {end - start} seconds.")
        ...
        print(f"Mark step took {end - start} seconds.")
        ...
        print(f"Token generation slot handling took {end - start} seconds.")
